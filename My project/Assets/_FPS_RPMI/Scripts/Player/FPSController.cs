...
public class FPSController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Dibujar Rayo ficticio en escena para determinar la orentación de la cámara
    ...
    void Movement()
    {
        Vector3 currentVelocity = rb.linearVelocity; //Necesitamos calcular la velocidad del rb constantemente
